<?php /* Template Name: Página de doações  */
if(current_user_can('administrator')) {  ?>
	<div style="background: red; color: #fff; text-align: center; font-size:12px; padding: 10px;">PAGE DOACAO | page-doacoes.php</div>
<?php }
get_header();
        ...
        <?php while(have_rows('card')): the_row(); ?>
            <div class="card mb-3 shadow-sm">
                <div class="row no-gutters">
                    ...
                    <?php } else { ?>
                        <img src="<?= esc_url($imgCard['url']); ?>" alt="<?php echo $imgCard['alt']; ?>" class="card-img-top">
                    <?php } ?>
                    </div>
