...
?>
<select class="filter-mobile filter-mobile-js" data-taxonomy="<?= $taxonomy ?>">
    <option value="">Todas as categorias</a>
        ...
        if ($top_level_terms) {
            foreach ($top_level_terms as $top_level_term) {
                ...
                echo '<script>console.log(' . $top_level_term . ');</script>';
        ?>
    <option value="<?php echo $top_level_term->slug; ?>"><?= $top_term_name; ?></option>
    <?php
